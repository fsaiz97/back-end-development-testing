...
let beasts = [
    ...
    { name: "Hippogriff", habitat: "Forbidden Forest", dangerRating: 3, description: "A proud, noble creature. Treat it with respect if you value your life", encounterRate: 0.2, loot: ["Hippogriff's claw", "Wing"] }
